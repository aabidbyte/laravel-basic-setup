<x-layouts.auth>
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('password.confirm.store') }}" class="flex flex-col gap-6">
            ...
            <x-ui.password name="password" :label="__('ui.auth.confirm_password.password_label')" required autocomplete="current-password" :placeholder="__('ui.auth.confirm_password.password_placeholder')"></x-ui.password>
