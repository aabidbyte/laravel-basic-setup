...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <title>{{ __('emails.welcome.subject', ['app' => $appName]) }}</title>
    </head>
    ...
    <body
        ...
        <div
            ...
            <h2 style="color: #333; margin-top: 0;">{{ __('emails.welcome.greeting', ['name' => $user->name]) }}</h2>

            <p>{{ __('emails.welcome.intro', ['app' => $appName]) }}</p>

            <p>{{ __('emails.welcome.ready') }}</p>
            ...
            <p>{{ __('emails.welcome.help') }}</p>

            <hr style="border: none; border-top: 1px solid #e0e0e0; margin: 20px 0;">

            <p style="color: #999; font-size: 12px; text-align: center;">
                {{ __('emails.welcome.footer', ['app' => $appName]) }}
            </p>
        </div>
    </body>
