...
export function confirmModal(config = {}) {
    return {
        ...
        handleConfirmModal(event) {
            ...
            if (cfg.confirmLabel || cfg.confirmText) this.confirmLabel = cfg.confirmLabel || cfg.confirmText;
            if (cfg.cancelLabel || cfg.cancelText) this.cancelLabel = cfg.cancelLabel || cfg.cancelText;
