...
export function actionModal() {
    return {
        ...
        init() {
            ...
            this._morphHookRemove = window.Livewire.hook('morph.updated', ({ component }) => {
                // Check if wire instance still exists (not destroyed by navigation)
                if (!this.$wire || !this.$wire.__instance) {
                    return;
                }
                if (component.id === this._wireId && this.modalIsOpen && this.$wire.modalView) {
        ...
        destroy() {
            ...
            if (this._morphHookRemove && typeof this._morphHookRemove === 'function') {
