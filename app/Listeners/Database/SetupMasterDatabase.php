...
class SetupMasterDatabase implements ShouldQueue
{
     ...
     * Handle the event.
     */
    public function handle(MasterCreated $event): void
    {
        $master = $event->master;
