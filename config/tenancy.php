...
return [
     ...
     */
    'cache' => [
        'tag_base' => Str::slug(env('APP_NAME', 'laravel'), '_') . '_tenant_', // This tag_base, followed by the tenant_id, will form a tag that will be applied on each cache call.
    ],
    ...
    'filesystem' => [
         ...
         */
        'suffix_base' => 'tenants/' . Str::slug(env('APP_NAME', 'laravel'), '_') . '_tenant_',
        'disks' => [
            'local',
            'public',
            // 's3',
     ...
     */
    'redis' => [
        'prefix_base' => Str::slug(env('APP_NAME', 'laravel'), '_') . '_tenant_', // Each key in Redis will be prepended by this prefix_base, followed by the tenant id.
