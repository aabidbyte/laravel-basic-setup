...
Source: https://tenancyforlaravel.com/docs/v3/the-two-applications
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="the-two-applications">The two applications</h1>
...
<ul>
<li>central application</li>
<li>tenant application</li>
</ul>
...
The tenant application is executed in tenant context — usually with the tenant's database, cache, etc. The central application is executed <strong>when there is no tenant</strong>.



The central application will house your signup page <strong>where tenants are created</strong>, your admin panel used to <strong>manage your tenants</strong>, etc.
...
The tenant application will likely house the larger part of your application — the real service being used by your tenants.
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/the-two-applications.blade.md" data-turbolinks="false"
