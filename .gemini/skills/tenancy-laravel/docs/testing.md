...
Source: https://tenancyforlaravel.com/docs/v3/testing
...
```
<code class="language-php">Event::fake([MyEvent::class]);
</code>
```
...
```
<code class="language-php">Event::fake();
</code>
```


<h2 id="central-app">Central app</h2>

To test your central app, just write normal Laravel tests.



<h2 id="tenant-app">Tenant app</h2>
...
```
<code class="language-php">class TestCase // extends ...
{
...
```
<code class="language-php">class FooTest extends TestCase
{
...
Or you may want to create a separate TestCase class for tenant tests, for better organization.
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/testing.blade.md" data-turbolinks="false"
