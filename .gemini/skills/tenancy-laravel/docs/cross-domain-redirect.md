...
Source: https://tenancyforlaravel.com/docs/v3/features/cross-domain-redirect
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="cross-domain-redirect">Cross-domain redirect</h1>
...
```
<code class="language-php">return redirect()-&gt;route('home')-&gt;domain($domain);
</code>
```
...
```
<code class="language-php">return redirect(tenant_route($domain, 'home'));
</code>
```

                            
                            
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/features/cross-domain-redirect.blade.md" data-turbolinks="false"
