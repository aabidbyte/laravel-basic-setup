...
Source: https://tenancyforlaravel.com/docs/v3/automatic-mode
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="automatic-mode">Automatic mode</h1>

By default, the package bootstraps tenancy automatically in the background. This means that when a tenant is identified (usually using middleware), the default database/cache/filesystem/etc is switched to that tenant's context. You can read more about this on the <a href="https://tenancyforlaravel.com/docs/v3/tenancy-bootstrappers">Tenancy bootstrappers</a> page.
...
<ul>
<li>Separation of concerns. Tenancy happens one layer below your application. If you need to change the details of how tenancy is bootstrapped, you can do that without having to change a ton of your app code.</li>
...
<li>Great integration with other packages. Switching the default database connection (and other things) is the only way to integrate many packages into the tenant part of the application. For example, you can use Laravel Nova to manage resources inside the tenant application.</li>
</ul>
                            
                            
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/automatic-mode.blade.md" data-turbolinks="false"
