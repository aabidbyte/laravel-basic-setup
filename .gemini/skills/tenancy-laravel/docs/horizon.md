...
Source: https://tenancyforlaravel.com/docs/v3/integrations/horizon
...
<blockquote>
  Note: <strong>Horizon is only accessible on the central domain</strong>. You can separate the jobs by <a href="#tags">tagging them with tenant IDs</a>.


</blockquote>

Make sure your <a href="https://tenancyforlaravel.com/docs/v3/queues">queues</a> are configured correctly before using this.
...
```
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/integrations/horizon.blade.md" data-turbolinks="false"
