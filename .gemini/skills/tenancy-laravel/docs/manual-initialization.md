...
Source: https://tenancyforlaravel.com/docs/v3/manual-initialization
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="manual-initialization">Manual initialization</h1>
...
```
<code class="language-php">$tenant = Tenant::find('some-id');
...
```
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/manual-initialization.md" data-turbolinks="false"
