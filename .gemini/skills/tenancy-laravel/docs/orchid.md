...
Source: https://tenancyforlaravel.com/docs/v3/integrations/orchid
        ...
        <ul class="my-0 list-reset">
            ...
            class="lvl2  active nav-menu__item"
                    >
            Orchid
        </a>
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="laravel-orchid">Laravel Orchid</h1>

First, set up tenancy following the <a href="https://tenancyforlaravel.com/docs/v3/quickstart">quickstart guide</a>, and install <a href="https://orchid.software/en/docs/installation/">Laravel Orchid</a>.
...
<ul>
<li>Enable <a href="https://tenancyforlaravel.com/docs/v3/features/universal-routes">universal routes</a>

</li>
<li>Add your tenant identification middleware to `config\platform.php` (feel free to use a different identification middleware):



```
<code class="language-php">'middleware' =&gt; [
...
<li>Add a route to `routes\platform.php`:



```
<code class="language-php">Route::screen('/', PlatformScreen::class)
    -&gt;name('platform.index')
...
<li>Add 'platform' middleware to your tenant routes (`routes\tenant.php`):



```
<code class="language-php">Route::middleware([
    'web',
    'platform',
...
<li>If listing users in the admin panel throws an exception, change line 55 in the UserListLayout class to `return $user-&gt;updated_at?-&gt;toDateTimeString()` (add null-safe operator)

</li>
</ul>
                            
                            
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/integrations/orchid.blade.md" data-turbolinks="false"
