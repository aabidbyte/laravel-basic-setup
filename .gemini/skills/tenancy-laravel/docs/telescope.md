...
Source: https://tenancyforlaravel.com/docs/v3/integrations/telescope
...
Enable the <em>Telescope tags</em> feature in the `tenancy.features` config to have all Telescope requests tagged with the current tenant's id.
...
Note that Telescope (&amp; its migrations) will be part of the central app.
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/integrations/telescope.blade.md" data-turbolinks="false"
