...
Source: https://tenancyforlaravel.com/docs/v3/integrations/livewire
...
```
<code class="language-php">'middleware_group' =&gt; ['web'],
</code>
```
...
```
<code class="language-php">'middleware_group' =&gt; [
    'web',
    'universal',
...
```
<code class="language-php">public function boot(): void
{
    // ...
...
```
<code class="language-php">// specify the right identification middleware
...
```
<code class="language-php">// config/livewire.php
...
Also make sure to enable <a href="https://tenancyforlaravel.com/docs/v3/features/universal-routes">universal routes</a>.



And if you're using file uploads, read the <a href="https://tenancyforlaravel.com/docs/v3/realtime-facades">Real-time facades</a> page of the documentation. Livewire uses real-time facades in the uploading logic.


                            
                            
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/integrations/livewire.blade.md" data-turbolinks="false"
