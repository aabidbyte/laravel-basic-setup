...
Source: https://tenancyforlaravel.com/docs/v3/realtime-facades
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="real-time-facades">Real-time facades</h1>
...
```
<code>storage/tenant123/app/foo.png
</code>
```
...
```
<code>storage/app/tenant123/foo.png
</code>
```
...
<h2 id="the-issue-with-real-time-facades">The issue with real-time facades</h2>
...
<h2 id="creating-framework-directories-for-tenants">Creating framework directories for tenants</h2>
...
<ol>
<li>you're using `storage_path()` suffixing (enabled in `tenancy` config)</li>
<li><strong>and</strong> you're using real-time facades</li>
</ol>

You can create these directories by using the <a href="https://tenancyforlaravel.com/docs/v3/event-system">event system</a>.
...
```
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/realtime-facades.blade.md" data-turbolinks="false"
