...
Source: https://tenancyforlaravel.com/docs/v3/migrations
...
To set these paths, go to your `config/tenancy.php` file and change the value of the <a href="https://github.com/stancl/tenancy/blob/f2a3cf028ce68e2d55c26751af0bd5a447269894/assets/config.php#L177">`--paths` parameter in `migration_parameters`</a>. You may specify any number of paths in that array.


                            
                            
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/migrations.blade.md" data-turbolinks="false"
