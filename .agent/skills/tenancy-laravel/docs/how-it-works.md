...
Source: https://tenancyforlaravel.com/docs/v3/how-it-works
...
<li>the domain is used to identify the tenant</li>
<li>the database, cache, etc are switched to that tenant's context</li>
</ul>
...
<a href="https://tenancyforlaravel.com/docs/v3/tenant-identification">Tenant identification</a>



<a href="https://tenancyforlaravel.com/docs/v3/event-system">Event system</a>



Note that even though the default assumes you're using domains and the database-per-tenant model, you're free to customize this any way you want. <strong>And it's easy to customize!</strong> Just read on to get an understanding of how everything works.
...
TODO: Expand. Why this approach, etc. Maybe on the other page?
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/how-it-works.blade.md" data-turbolinks="false"
