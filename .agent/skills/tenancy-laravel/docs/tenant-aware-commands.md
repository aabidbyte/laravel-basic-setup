...
Source: https://tenancyforlaravel.com/docs/v3/tenant-aware-commands
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="tenant-aware-commands">Tenant-aware commands</h1>

Even though <a href="https://tenancyforlaravel.com/docs/v3/console-commands#run">`tenants:run`</a> lets you run arbitrary artisan commands for tenants, you may want to have strictly tenant commands.
...
```
<code class="language-php">class MyCommand extends Command
{
...
<p>If you don't want to implement the options/arguments yourself, you may use one of these two traits:
- `HasATenantsOption` - accepts multiple tenant IDs, optional -- by default the command is executed for all tenants
- `HasATenantArgument` - accepts a single tenant ID, required argument</p>
...
```
<code class="language-php">class FooCommand extends Command
{
...
```
<code class="language-php">tenancy()-&gt;find($this-&gt;argument('tenant_id'))-&gt;run(function () {
...
```
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/tenant-aware-commands.blade.md" data-turbolinks="false"
