...
Source: https://tenancyforlaravel.com/docs/v3/multi-database-tenancy
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="multi-database-tenancy">Multi-database tenancy</h1>

The package comes with all the tooling necessary for multi-database tenancy.



<h2 id="tenantdatabasemanagers">TenantDatabaseManagers</h2>
...
There are also commands for working with tenant databases. Namely, `tenants:migrate` and `tenants:seed`. See the <a href="https://tenancyforlaravel.com/docs/v3/console-commands">console commands page</a> of the documentation.



<h2 id="jobs-listeners">Jobs &amp; Listeners</h2>

By default, when a tenant is created, there's also a database created for him. This is done using a JobPipeline listener in the `TenancyServiceProvider`. See the <a href="https://tenancyforlaravel.com/docs/v3/event-system">event system page</a> of the documentation.


                            
                            
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/multi-database-tenancy.blade.md" data-turbolinks="false"
