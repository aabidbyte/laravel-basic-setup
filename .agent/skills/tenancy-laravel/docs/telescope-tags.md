...
Source: https://tenancyforlaravel.com/docs/v3/features/telescope-tags
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="telescope-tags">Telescope tags</h1>

<a href="https://github.com/laravel/telescope">Laravel Telescope</a> provides insight into the requests coming into your application. You can filter those requests by tag. You can automatically tag all requests by the active tenant by enabling the Telescope tag feature.



<h2 id="enabling-the-feature"><strong>Enabling the feature</strong></h2>
...
```
<code class="language-php">// Stancl\Tenancy\Features\TelescopeTags::class,
</code>
```

                            
                            
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/features/telescope-tags.blade.md" data-turbolinks="false"
