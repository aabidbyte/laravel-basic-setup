...
Source: https://tenancyforlaravel.com/docs/v3/features/vite-bundler
        ...
        <ul class="my-0 list-reset">
            ...
            Universal (Central &amp; Tenant) Nova
                                ...
                                <h1 id="vite-bundler">Vite bundler</h1>
...
```
<code class="language-php">'features' =&gt; [
    // [...]
...
```
                                ...
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/features/vite-bundler.blade.md" data-turbolinks="false"
