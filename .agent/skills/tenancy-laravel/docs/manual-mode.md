...
Source: https://tenancyforlaravel.com/docs/v3/manual-mode
...
<blockquote>
  See: <a href="https://tenancyforlaravel.com/docs/v3/automatic-mode">Automatic mode</a>


</blockquote>

If you wish to use the package only to keep track of the current tenant and make the application tenant-aware manually — without using the <a href="https://tenancyforlaravel.com/docs/v3/tenancy-bootstrappers">Tenancy bootstrappers</a>, you can absolutely do that.
...
```
<code class="language-php">// app/Providers/TenancyServiceProvider.php
...
This approach is generally discouraged, because you lose all of the benefits of the <a href="https://tenancyforlaravel.com/docs/v3/automatic-mode">automatic mode</a>, but <strong>there won't be any issues with the package</strong> if you decide to use the manual mode. You might not be able to integrate other packages as easily, but if for whatever reason it makes more sense for your project to use this approach, feel comfortable to do so.


                            
                            
                                <a href="https://github.com/stancl/tenancy-docs/edit/master/source/docs/v3/manual-mode.blade.md" data-turbolinks="false"
